...
<ul class="nav nav-tabs mb-3">
  ...
  <li class="nav-item">
    <a class="nav-link bg-light active" style="color:blue;" aria-current="page" href="#"><b>Department Head</b></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" aria-current="page" href="admin_faculty2.php">Program Head</a>
  </li>
</ul>
			...
			include_once "includes/conn.php";
					...
					$sql= "SELECT f.id,f.firstname, f.middlename,f.lastname,d.department,f.email,f.password FROM faculty f 
					JOIN department d
					ON d.id=f.department
			    ...
			    <tr>
			      ...
			      <td>
			      	...
			      	<a href="edit_faculty_acc.php?id=<?php echo $faculty['id']; ?>" class="btn btn-success" type="button" name="edit"> <i class="bi bi-pencil-square"></i></a>
