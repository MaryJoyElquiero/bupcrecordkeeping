...
<div class="container">
	<div class="row justify-content-center box">
		...
		<div class="col-md-5 submission">
			<div class="row">
			<div style="font-size: 18px; font-weight: 500;"> To Submit</div>
			<hr>
			</div>
	 		...
	 		?>
											...
											ON s.doc_id=d.id
											 ...
											 AND s.stud_id='{$_SESSION['uid']}';";
												...
												if (!$missed==0) {
													...
													<div class="card mb-3">
														<div class="card-body">
															<p style="color: red; margin: 0"><b><?php echo $missed;  ?> Missed  &ensp;&ensp;&ensp;<i class="bi bi-arrow-right"></i></b></p>
														</div>
													</div>
													</a>
													<?php
				...
				<input type="hidden" name="stud_id" value="<?php echo $_SESSION['uid']; ?>">					
						<div class="card mb-1">
							<div class="card-body">
								<label for="formFile" class="form-label" style="font-size: 18px; font-weight: 500;"><i class="bi bi-file-earmark-text-fill" style="font-size:24px; color: #37af96; "></i> <?php echo $docs['documents']; ?></label>

								<p style="font-size: 14px; color: #37af96; margin: 0;"> Submission Due : 
								 <b>		
				...
				<div class="row">
					...
					<?php
					    ...
					    if (!empty($arr)) {
					  		...
					  		<a href="submitted.php?id=<?php echo $_SESSION['uid']; ?>" class="view"> <i class="bi bi-printer" style="font-size: 20px; font-weight: 600;"></i> Print list</a>
					  		<?php
					  	}
					  	else{
