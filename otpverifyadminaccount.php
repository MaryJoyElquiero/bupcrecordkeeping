...
<html>
<head>
	<title>OTP Verification| Admin</title>
	...
	<div class="row justify-content-center">
		...
		<div class="col-md stdnt">
			...
			<div class="mb-3 mt-3">
			  ...
			  <button class="btn" type="submit" name="adminverify"> Verify </button>			
			</div>
			...
			<div class="span mt-3" style="text-align: left;">
				<div class="span mt-3" style="text-align: left;">
					<form action="includes/resendcode.php" method="POST">
						<input type="hidden" name="email" value="<?php echo $_GET['email']; ?>">
						<button type="submit" name="adminresend" style="text-decoration: underline; outline: none; border: 0; background-color:white; color: #37af96;"> Resend Code</button>
					</form>
				</div>
			</div>
