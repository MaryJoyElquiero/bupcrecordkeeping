			...
			$acad_y=$_GET['acad_id'];
				...
				$acad_y= $ay[0];
		  		...
		  		<div class="col-sm-5 mt-2">
					  ...
					  while($row1 = $result->fetch_assoc()) {
					  	?>
					  	<p style="font-size: 24px; font-weight: 600;"><i class="bi bi-file-earmark-text" style="font-size: 40px; "></i> <?php echo $row1['documents'] ?> -Unsubmitted</p>
					  	<?php
					  }
				...
				?>
					  ...
					  <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">	
						...
						<li>
					  <a class="dropdown-item" name="flter_course" href="folderdata2.php?id=<?php echo $_GET['id']; ?>&&acad_id=<?php echo $ac['id']; ?>"><?php echo $ac['acad_year']; ?></a></li>	 
	 					</form>
		...
		<hr>
		  	...
		  	<div class="row" style="margin-left: 10px; margin-right: 10px;">
		  		...
		  		<div class="col-md-6">
					  ...
					  <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">	
					  	  <li><a class="dropdown-item" href="folderdata2.php?id=<?php echo $_GET['id']; ?>&&acad_id=<?php echo $acad_y; ?>">All</a></li>
				...
				<?php 
				 include_once "includes/conn.php";
					  $sql="SELECT * FROM course;";
					    ...
					    <li>
					    	<a class="dropdown-item" name="flter_course" href="folderdata2.php?id=<?php echo $_GET['id']; ?>&&course_id=<?php echo $course['id']; ?>&&acad_id=<?php echo $acad_y; ?>"><?php echo $course['course']; ?></a></li>
	 ...
	 <?php 	}} ?>
				 ...
				 include_once "includes/conn.php";
					  $sql="SELECT * FROM department;";
			  			...
			  			?>
					    <li><a class="dropdown-item" href="folderdata2.php?id=<?php echo $_GET['id']; ?>&&dept_id=<?php echo $dept['id']; ?>&&acad_id=<?php echo $acad_y; ?>"><?php echo $dept['department']; ?></a></li>
					  <?php }} ?>
					  </ul>
					</div>
		  		</div>
