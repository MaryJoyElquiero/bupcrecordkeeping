...
<html>
<head>
	<title>OTP Verification| Faculty</title>
			  ...
			  <button class="btn" type="submit" name="facultyverify"> Verify </button>			
				...
				<div class="span mt-3" style="text-align: left;">
					<form action="includes/resendcode.php" method="POST">
						<input type="hidden" name="email" value="<?php echo $_GET['email']; ?>">
						<button type="submit" name="facultyresend1" style="text-decoration: underline; outline: none; border: 0; background-color:white; color: #37af96;"> Resend Code</button>
					</form>
				</div>
