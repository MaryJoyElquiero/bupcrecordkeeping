...
<div class="container-fluid">
	...
	<div class="row justify-content-center">
		...
		<div class="col-md stdnt">
			...
			<div class="mb-3 mt-3">
			  <button class="btn" type="submit" name="flogin"> Log in</button>			
			</div>
			<div class="span" style="text-align: left; "><a href="forgotpass_faculty.php" style="color:#37af96; ">Forgot Password?</a></div>
			</form>		
		</div>
		</div>
		</div>
