...
<ul class="nav nav-tabs mb-3">
  <li class="nav-item">
    <a class="nav-link bg-light active" aria-current="page" href="#" style="color:blue;"><b>Student</b></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="admin_faculty.php">Department Head</a>
  </li>
   <li class="nav-item">
    <a class="nav-link" href="admin_faculty2.php">Program Head</a>
  </li>
</ul>
			...
			include_once "includes/conn.php";
					...
					$sql= "SELECT a.id, a.firstName, a.middleName, a.lastName, d.department,c.course, a.email, a.password FROM accounts a 
					JOIN department d
					...
					$stmt=mysqli_stmt_init($conn);
						...
						foreach ($arr as $key => $acc) {
			  			?>
			    <tr>
			      <td><?php echo $acc['lastName'].", ". $acc['firstName']." ". $acc['middleName']; ?></td>
			      <td><?php echo $acc['department']; ?></td>
			      <td><?php echo $acc['course']; ?></td>
			      <td><?php echo $acc['email']; ?></td class="hidetext">
			      <td class="hidetext"><?php echo $acc['password']; ?></td>
			      <td>
			      		
			      	<input type="hidden" name="stud_id" value="<?php echo $acc['id']; ?>">
			      	<a href="edit_student_acc.php?id=<?php echo $acc['id']; ?>" class="btn btn-success" type="button" name="edit"> <i class="bi bi-pencil-square"></i></a>
			      	<button class="btn btn-danger" name="delete" data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $acc['id']; ?>"> <i class="bi bi-trash"></i> </button>


			      				      	<!-- Modal -->
<div class="modal fade" id="exampleModal<?php echo $acc['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Submitted files of this account will be deleted. This cannot be undone.
      </div>
      <div class="modal-footer">
      	
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
         <form action="includes/deletestud.php" method="POST">
      	<input type="hidden" name="stud_id" value="<?php echo $acc['id']; ?>">
